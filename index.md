...
<div style="margin: 0.5em 0 1.6em 0; display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
  ...
  <form action="https://submit-form.com/kxienKoQo" method="POST" style="display: flex; align-items: center; gap: 6px; margin: 0; flex: 1; max-width: 360px;">
    ...
    <!-- 紧凑橙色按钮 -->
    <button type="submit" 
            style="height: 32px; padding: 0 10px; background-color: #ff6600; color: #ffffff; font-weight: 600; font-size: 0.85em; border: none; border-radius: 4px; cursor: pointer; white-space: nowrap; box-sizing: border-box; transition: opacity 0.2s;"
